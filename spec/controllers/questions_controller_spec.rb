...
describe QuestionsController do
  ...
  let(:valid_attributes) { { "test_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved question as @question" do
        ...
        post :create, {:question => { "test_id" => "invalid value" }}, valid_session
        expect(assigns(:question)).to be_a_new(Question)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested question" do
        ...
        expect_any_instance_of(Question).to receive(:update).with({ "test_id" => "1" })
        put :update, {:id => question.to_param, :question => { "test_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the question as @question" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Question).to receive(:save).and_return(false)
        put :update, {:id => question.to_param, :question => { "test_id" => "invalid value" }}, valid_session
        expect(assigns(:question)).to eq(question)
      end
